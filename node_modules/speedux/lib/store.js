...
var store = {
  ...
  buildInstance: function buildInstance() {
    ...
    this.devTools = this.devTools || (0, _redux.compose)(devToolsExtension);
    this.storeInstance = (0, _redux.createStore)(this.getRootReducer(), _redux.compose.apply(void 0, this.middlewares.concat([this.devTools])));
  ...
  buildRootReducer: function buildRootReducer() {
    ...
    var reducers = (0, _extends2["default"])({}, this.reducers);
  ...
  useMiddleware: function useMiddleware(middleware) {
    this.middlewares.unshift((0, _redux.applyMiddleware)(middleware));
  },
  ...
  getState: function getState(query) {
    return (0, _noyb.queryObject)(query, this.cachedState);
  },
